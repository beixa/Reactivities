...
namespace Application.Followers
{
    public class List
    {
        ...
        { 
            ...
            public string Predicate { get; set; } // to identify which list we want to return
        }
        ...
        public class Handler : IRequestHandler<Query, List<Profile>>
        {
            ...
            {
                var queryable = _context.Followings.AsQueryable(); //Iqueryable thats gonna contain user followings and we want to populate this based on predicate
